...
public class AttendanceController {
    ...
    public String attendancePage(Model model,
        ...
        if (rows == null || rows.isEmpty()) {
            ...
            List<Map<String,Object>> mapped = rows.stream().map(a -> {
                Map<String, Object> map = new java.util.HashMap<>();
                map.put("date", a.getDate().toString());
                map.put("morningIn", a.getMorningIn()==null?"":a.getMorningIn().toString());
                map.put("morningOut", a.getMorningOut()==null?"":a.getMorningOut().toString());
                map.put("afternoonIn", a.getAfternoonIn()==null?"":a.getAfternoonIn().toString());
                map.put("afternoonOut", a.getAfternoonOut()==null?"":a.getAfternoonOut().toString());
                map.put("remarks", a.getRemarks()==null?"":a.getRemarks());
                map.put("id", a.getId());
                return map;
